...
public class BoardDAO {
	...
	public void postDel(BoardDTO dto) {
		Connection con = null;
		PreparedStatement pstmt = null;
		String sql = "UPDATE may_board SET b_del=1 "
				+ "WHERE b_no=? AND m_no="
	...
	public void commentwirte(CommentDTO dto) {
		Connection con = null;
		PreparedStatement pstmt = null;
	...
	public void commentUpdate(CommentDTO dto) {
	      Connection con = null;
	      PreparedStatement pstmt = null;
	      String sql = "UPDATE may_comment SET c_comment=?"
	            + " WHERE c_no=? AND m_no=(SELECT m_no FROM may_member WHERE m_id=?)";
	      //SELECT부분은 '내 글만 수정한다'는 의미!
